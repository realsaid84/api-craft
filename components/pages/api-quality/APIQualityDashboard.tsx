...
interface APIQualityDashboardProps {
  apiSpec?: any;
  title?: string;
  onBack?: () => void;
}
...
export const APIQualityDashboard: React.FC<APIQualityDashboardProps> = ({ 
  apiSpec, 
  ...
  // Quality scores (randomized based on API title)
  ...
  // Process API spec and generate metrics
  useEffect(() => {
    ...
    try {
      ...
      const apiTitle = processedSpec?.info?.title || "Untitled API";
      
      // Generate randomized metrics based on API title
      ...
      console.error('Error analyzing API spec:', err);
      setError(`Failed to analyze API: ${err instanceof Error ? err.message : 'Unknown error'}`);
    } finally {
      setLoading(false);
    }
  }, [apiSpec, spec]);
    ...
    reader.onload = (e) => {
      try {
        ...
        if (!parsed.openapi && !parsed.swagger) {
          throw new Error('The uploaded file is not a valid OpenAPI specification');
        }
  ...
  const downloadReport = () => {
    const report = {
      ...
      apiName: (apiSpec || spec)?.info?.title || "Untitled API",
      metrics,
      violations,
      securityChecks,
    ...
    return (
      <div className="flex items-center justify-center min-h-[500px]">
        <div className="text-center">
          ...
          <p className="text-gray-600">Analyzing API specification...</p>
        </div>
      </div>
    );
  }
          ...
          <>
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between">
                    <div className="mb-4 md:mb-0">
                      <h2 className="text-xl font-semibold text-gray-700 mb-2">
                        {(apiSpec || spec)?.info?.title || "Untitled API"}
                      </h2>
                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <div className="text-center">
                        ...
                        <div className="text-sm text-gray-500">Overall API score</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="p-4 border rounded-md bg-gray-50">
                        {metrics.overall >= 90 ? (
                          ...
                          <p className="text-gray-700">
                            Great job! Your API specification is in good shape. There are just a few minor issues to address to make it perfect.
                          ...
                          <p className="text-gray-700">
                            Your API specification needs work. There are {violations.errors} errors that need to be fixed,
                        ...
                        {metrics.overall < 90 && (
                          <div className="mt-4">
                            ...
                            <ul className="space-y-1">
                              {ruleCategories.slice(0, 3).map((rule, index) => (
            ...
            <TabsContent value="problems">
             ...
             <TabsContent value="objects">   
                  {activeTab === 'objects' && (
                    <div className="mt-8">
                      <h3 className="text-lg font-medium mb-4">API Objects</h3>
                      <div className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          <Card className="border-gray-200">
                            ...
                            <CardContent>
                              ...
                              <div className="mt-2 text-sm text-gray-500">
                                API paths defined in the specification
                              </div>
                            </CardContent>
                          </Card>
